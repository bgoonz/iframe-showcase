...
geoBtn.onclick = function () {
  console.log(
    "Permission currently denied; future features of the Permissions API will allow us to request permission here."
  );
  console.log(
    "Currently you have to reset the permission state using the browser UI."
  );
  console.log(
    "In Firefox it is done with Tools > Page Info > Permissions > Access Your Location."
  );
};
