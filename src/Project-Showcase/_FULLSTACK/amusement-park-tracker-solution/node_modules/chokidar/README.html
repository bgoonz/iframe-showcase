...
<a class="sourceLine" id="cb3-41" title="41"><span class="va">watcher</span>.<span class="at">unwatch</span>(<span class="st">&#39;new-file*&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb3-42" title="42"></a>
<a class="sourceLine" id="cb3-43" title="43"><span class="co">// Stop watching.</span></a>
<a class="sourceLine" id="cb3-44" title="44"><span class="va">watcher</span>.<span class="at">close</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb3-45" title="45"></a>
<a class="sourceLine" id="cb3-46" title="46"><span class="co">// Full list of options. See below for descriptions.</span></a>
<a class="sourceLine" id="cb3-47" title="47"><span class="co">// Do not use this example!</span></a>
<a class="sourceLine" id="cb3-48" title="48"><span class="va">chokidar</span>.<span class="at">watch</span>(<span class="st">&#39;file&#39;</span><span class="op">,</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb3-49" title="49">  <span class="dt">persistent</span><span class="op">:</span> <span class="kw">true</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-50" title="50"></a>
<a class="sourceLine" id="cb3-51" title="51">  <span class="dt">ignored</span><span class="op">:</span> <span class="st">&#39;*.txt&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-52" title="52">  <span class="dt">ignoreInitial</span><span class="op">:</span> <span class="kw">false</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-53" title="53">  <span class="dt">followSymlinks</span><span class="op">:</span> <span class="kw">true</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-54" title="54">  <span class="dt">cwd</span><span class="op">:</span> <span class="st">&#39;.&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-55" title="55">  <span class="dt">disableGlobbing</span><span class="op">:</span> <span class="kw">false</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-56" title="56"></a>
<a class="sourceLine" id="cb3-57" title="57">  <span class="dt">usePolling</span><span class="op">:</span> <span class="kw">false</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-58" title="58">  <span class="dt">interval</span><span class="op">:</span> <span class="dv">100</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-59" title="59">  <span class="dt">binaryInterval</span><span class="op">:</span> <span class="dv">300</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-60" title="60">  <span class="dt">alwaysStat</span><span class="op">:</span> <span class="kw">false</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-61" title="61">  <span class="dt">depth</span><span class="op">:</span> <span class="dv">99</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-62" title="62">  <span class="dt">awaitWriteFinish</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb3-63" title="63">    <span class="dt">stabilityThreshold</span><span class="op">:</span> <span class="dv">2000</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-64" title="64">    <span class="dt">pollInterval</span><span class="op">:</span> <span class="dv">100</span></a>
<a class="sourceLine" id="cb3-65" title="65">  <span class="op">},</span></a>
<a class="sourceLine" id="cb3-66" title="66"></a>
<a class="sourceLine" id="cb3-67" title="67">  <span class="dt">ignorePermissionErrors</span><span class="op">:</span> <span class="kw">false</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-68" title="68">  <span class="dt">atomic</span><span class="op">:</span> <span class="kw">true</span> <span class="co">// or a custom &#39;atomicity delay&#39;, in milliseconds (default 100)</span></a>
<a class="sourceLine" id="cb3-69" title="69"><span class="op">}</span>)<span class="op">;</span></a></code></pre></div>
...
<ul>
<li><strong>v3.3 (Nov 2, 2019):</strong> <code>FSWatcher#close()</code> method became async.</li>
