...
<p>or</p>
<div class="sourceCode" id="cb2"><pre class="sourceCode bash"><code class="sourceCode bash"><a class="sourceLine" id="cb2-1" title="1"><span class="ex">bower</span> install jsdiff --save</a></code></pre></div>
<h2 id="api">API</h2>
<ul>
...
<a class="sourceLine" id="cb3-2" title="2">  <span class="dt">oldFileName</span><span class="op">:</span> <span class="st">&#39;oldfile&#39;</span><span class="op">,</span> <span class="dt">newFileName</span><span class="op">:</span> <span class="st">&#39;newfile&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-3" title="3">  <span class="dt">oldHeader</span><span class="op">:</span> <span class="st">&#39;header1&#39;</span><span class="op">,</span> <span class="dt">newHeader</span><span class="op">:</span> <span class="st">&#39;header2&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-4" title="4">  <span class="dt">hunks</span><span class="op">:</span> [<span class="op">{</span></a>
<a class="sourceLine" id="cb3-5" title="5">    <span class="dt">oldStart</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="dt">oldLines</span><span class="op">:</span> <span class="dv">3</span><span class="op">,</span> <span class="dt">newStart</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="dt">newLines</span><span class="op">:</span> <span class="dv">3</span><span class="op">,</span></a>
<a class="sourceLine" id="cb3-6" title="6">    <span class="dt">lines</span><span class="op">:</span> [<span class="st">&#39; line2&#39;</span><span class="op">,</span> <span class="st">&#39; line3&#39;</span><span class="op">,</span> <span class="st">&#39;-line4&#39;</span><span class="op">,</span> <span class="st">&#39;+line5&#39;</span><span class="op">,</span> <span class="st">&#39;</span><span class="sc">\\</span><span class="st"> No newline at end of file&#39;</span>]<span class="op">,</span></a>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="at">require</span>(<span class="st">&#39;colors&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb4-2" title="2"><span class="kw">var</span> jsdiff <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;diff&#39;</span>)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb4-5" title="5"><span class="kw">var</span> other <span class="op">=</span> <span class="st">&#39;beep boob blah&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb4-6" title="6"></a>
<a class="sourceLine" id="cb4-7" title="7"><span class="kw">var</span> diff <span class="op">=</span> <span class="va">jsdiff</span>.<span class="at">diffChars</span>(one<span class="op">,</span> other)<span class="op">;</span></a>
<a class="sourceLine" id="cb4-8" title="8"></a>
<a class="sourceLine" id="cb4-9" title="9"><span class="va">diff</span>.<span class="at">forEach</span>(<span class="kw">function</span>(part)<span class="op">{</span></a>
<a class="sourceLine" id="cb4-10" title="10">  <span class="co">// green for additions, red for deletions</span></a>
<a class="sourceLine" id="cb4-11" title="11">  <span class="co">// grey for common parts</span></a>
<a class="sourceLine" id="cb4-12" title="12">  <span class="kw">var</span> color <span class="op">=</span> <span class="va">part</span>.<span class="at">added</span> <span class="op">?</span> <span class="st">&#39;green&#39;</span> :</a>
<a class="sourceLine" id="cb4-13" title="13">    <span class="va">part</span>.<span class="at">removed</span> <span class="op">?</span> <span class="st">&#39;red&#39;</span> : <span class="st">&#39;grey&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb4-14" title="14">  <span class="va">process</span>.<span class="va">stderr</span>.<span class="at">write</span>(<span class="va">part</span>.<span class="at">value</span>[color])<span class="op">;</span></a>
<a class="sourceLine" id="cb4-15" title="15"><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb4-16" title="16"></a>
<a class="sourceLine" id="cb4-17" title="17"><span class="va">console</span>.<span class="at">log</span>()<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode html"><code class="sourceCode html"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">&lt;pre</span><span class="ot"> id=</span><span class="st">&quot;display&quot;</span><span class="kw">&gt;&lt;/pre&gt;</span></a>
<a class="sourceLine" id="cb5-2" title="2"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;diff.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb5-3" title="3"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb5-4" title="4"><span class="kw">var</span> one <span class="op">=</span> <span class="st">&#39;beep boop&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb5-5" title="5">    other <span class="op">=</span> <span class="st">&#39;beep boob blah&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb5-6" title="6">    color <span class="op">=</span> <span class="st">&#39;&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb5-7" title="7">    span <span class="op">=</span> <span class="kw">null</span><span class="op">;</span></a>
<a class="sourceLine" id="cb5-8" title="8"></a>
<a class="sourceLine" id="cb5-9" title="9"><span class="kw">var</span> diff <span class="op">=</span> <span class="va">JsDiff</span>.<span class="at">diffChars</span>(one<span class="op">,</span> other)<span class="op">,</span></a>
<a class="sourceLine" id="cb5-10" title="10">    display <span class="op">=</span> <span class="va">document</span>.<span class="at">getElementById</span>(<span class="st">&#39;display&#39;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb5-11" title="11">    fragment <span class="op">=</span> <span class="va">document</span>.<span class="at">createDocumentFragment</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb5-12" title="12"></a>
<a class="sourceLine" id="cb5-13" title="13"><span class="va">diff</span>.<span class="at">forEach</span>(<span class="kw">function</span>(part)<span class="op">{</span></a>
<a class="sourceLine" id="cb5-14" title="14">  <span class="co">// green for additions, red for deletions</span></a>
<a class="sourceLine" id="cb5-15" title="15">  <span class="co">// grey for common parts</span></a>
<a class="sourceLine" id="cb5-16" title="16">  color <span class="op">=</span> <span class="va">part</span>.<span class="at">added</span> <span class="op">?</span> <span class="st">&#39;green&#39;</span> :</a>
<a class="sourceLine" id="cb5-17" title="17">    <span class="va">part</span>.<span class="at">removed</span> <span class="op">?</span> <span class="st">&#39;red&#39;</span> : <span class="st">&#39;grey&#39;</span><span class="op">;</span></a>
<a class="sourceLine" id="cb5-18" title="18">  span <span class="op">=</span> <span class="va">document</span>.<span class="at">createElement</span>(<span class="st">&#39;span&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-19" title="19">  <span class="va">span</span>.<span class="va">style</span>.<span class="at">color</span> <span class="op">=</span> color<span class="op">;</span></a>
<a class="sourceLine" id="cb5-20" title="20">  <span class="va">span</span>.<span class="at">appendChild</span>(document</a>
<a class="sourceLine" id="cb5-21" title="21">    .<span class="at">createTextNode</span>(<span class="va">part</span>.<span class="at">value</span>))<span class="op">;</span></a>
<a class="sourceLine" id="cb5-22" title="22">  <span class="va">fragment</span>.<span class="at">appendChild</span>(span)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-23" title="23"><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-24" title="24"></a>
<a class="sourceLine" id="cb5-25" title="25"><span class="va">display</span>.<span class="at">appendChild</span>(fragment)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-26" title="26"><span class="kw">&lt;/script&gt;</span></a></code></pre></div>
