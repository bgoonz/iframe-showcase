...
<p><a href="https://travis-ci.org/form-data/form-data"><img src="https://img.shields.io/travis/form-data/form-data/v2.5.1.svg?label=linux:4.x-12.x" alt="Linux Build" /></a> <a href="https://travis-ci.org/form-data/form-data"><img src="https://img.shields.io/travis/form-data/form-data/v2.5.1.svg?label=macos:4.x-12.x" alt="MacOS Build" /></a> <a href="https://travis-ci.org/form-data/form-data"><img src="https://img.shields.io/travis/form-data/form-data/v2.5.1.svg?label=windows:4.x-12.x" alt="Windows Build" /></a></p>
<p><a href="https://coveralls.io/github/form-data/form-data?branch=master"><img src="https://img.shields.io/coveralls/form-data/form-data/v2.5.1.svg?label=code+coverage" alt="Coverage Status" /></a> <a href="https://david-dm.org/form-data/form-data"><img src="https://img.shields.io/david/form-data/form-data.svg" alt="Dependency Status" /></a></p>
...
<li><a href="https://github.com/form-data/form-data#array-getheaders-array-userheaders-"><em>Array</em> getHeaders( [<strong>Array</strong> <em>userHeaders</em>] )</a></li>
...
<h4 id="array-getheaders-array-userheaders"><em>Array</em> getHeaders( [<strong>Array</strong> <em>userHeaders</em>] )</h4>
<p>This method ads the correct <code>content-type</code> header to the provided array of <code>userHeaders</code>.</p>
<h4 id="string-getboundary"><em>String</em> getBoundary()</h4>
<p>Return the boundary of the formData. A boundary consists of 26 <code>-</code> followed by 24 numbers for example:</p>
