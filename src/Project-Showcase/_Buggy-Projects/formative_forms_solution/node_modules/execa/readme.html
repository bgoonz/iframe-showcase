...
<body>
<h1 id="execa-build-status-linux-build-status-windows-coverage-status">execa <a href="https://travis-ci.org/sindresorhus/execa"><img src="https://travis-ci.org/sindresorhus/execa.svg?branch=master" alt="Build Status: Linux" /></a> <a href="https://ci.appveyor.com/project/sindresorhus/execa/branch/master"><img src="https://ci.appveyor.com/api/projects/status/x5ajamxtjtt93cqv/branch/master?svg=true" alt="Build status: Windows" /></a> <a href="https://coveralls.io/github/sindresorhus/execa?branch=master"><img src="https://coveralls.io/repos/github/sindresorhus/execa/badge.svg?branch=master" alt="Coverage Status" /></a></h1>
<blockquote>
...
<pre><code>$ npm install --save execa</code></pre>
...
<a class="sourceLine" id="cb2-3" title="3"><span class="at">execa</span>(<span class="st">&#39;echo&#39;</span><span class="op">,</span> [<span class="st">&#39;unicorns&#39;</span>]).<span class="at">then</span>(result <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb2-4" title="4">    <span class="va">console</span>.<span class="at">log</span>(<span class="va">result</span>.<span class="at">stdout</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-5" title="5">    <span class="co">//=&gt; &#39;unicorns&#39;</span></a>
<a class="sourceLine" id="cb2-6" title="6"><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-7" title="7"></a>
<a class="sourceLine" id="cb2-8" title="8"><span class="co">// pipe the child process stdout to the current stdout</span></a>
<a class="sourceLine" id="cb2-9" title="9"><span class="at">execa</span>(<span class="st">&#39;echo&#39;</span><span class="op">,</span> [<span class="st">&#39;unicorns&#39;</span>]).<span class="va">stdout</span>.<span class="at">pipe</span>(<span class="va">process</span>.<span class="at">stdout</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-10" title="10"></a>
<a class="sourceLine" id="cb2-11" title="11"><span class="va">execa</span>.<span class="at">shell</span>(<span class="st">&#39;echo unicorns&#39;</span>).<span class="at">then</span>(result <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb2-12" title="12">    <span class="va">console</span>.<span class="at">log</span>(<span class="va">result</span>.<span class="at">stdout</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-13" title="13">    <span class="co">//=&gt; &#39;unicorns&#39;</span></a>
<a class="sourceLine" id="cb2-14" title="14"><span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-15" title="15"></a>
<a class="sourceLine" id="cb2-16" title="16"><span class="co">// example of catching an error</span></a>
<a class="sourceLine" id="cb2-17" title="17"><span class="va">execa</span>.<span class="at">shell</span>(<span class="st">&#39;exit 3&#39;</span>).<span class="at">catch</span>(error <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb2-18" title="18">    <span class="va">console</span>.<span class="at">log</span>(error)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-19" title="19">    <span class="co">/*</span></a>
<a class="sourceLine" id="cb2-20" title="20"><span class="co">    {</span></a>
<a class="sourceLine" id="cb2-21" title="21"><span class="co">        message: &#39;Command failed: /bin/sh -c exit 3&#39;</span></a>
<a class="sourceLine" id="cb2-22" title="22"><span class="co">        killed: false,</span></a>
<a class="sourceLine" id="cb2-23" title="23"><span class="co">        code: 3,</span></a>
<a class="sourceLine" id="cb2-24" title="24"><span class="co">        signal: null,</span></a>
<a class="sourceLine" id="cb2-25" title="25"><span class="co">        cmd: &#39;/bin/sh -c exit 3&#39;,</span></a>
<a class="sourceLine" id="cb2-26" title="26"><span class="co">        stdout: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb2-27" title="27"><span class="co">        stderr: &#39;&#39;,</span></a>
<a class="sourceLine" id="cb2-28" title="28"><span class="co">        timedOut: false</span></a>
...
<h3 id="execa.stdoutfile-arguments-options">execa.stdout(file, [arguments], <a href="#options">options</a>)</h3>
<p>Same as <code>execa()</code>, but returns only <code>stdout</code>.</p>
<h3 id="execa.stderrfile-arguments-options">execa.stderr(file, [arguments], <a href="#options">options</a>)</h3>
<p>Same as <code>execa()</code>, but returns only <code>stderr</code>.</p>
<h3 id="execa.shellcommand-options">execa.shell(command, <a href="#options">options</a>)</h3>
...
<h3 id="execa.shellsyncfile-options">execa.shellSync(file, <a href="#options">options</a>)</h3>
...
<p>Type: <code>Array</code> <code>string</code><br> Default: <code>pipe</code></p>
...
<p>Type: <code>boolean</code> <code>string</code><br> Default: <code>false</code></p>
...
<p>Type: <code>number</code><br> Default: <code>10000000</code> (10MB)</p>
<p>Largest amount of data in bytes allowed on <code>stdout</code> or <code>stderr</code>.</p>
<h4 id="killsignal">killSignal</h4>
<p>Type: <code>string</code> <code>number</code><br> Default: <code>SIGTERM</code></p>
<p>Signal value to be used when the spawned process will be killed.</p>
<h4 id="stdin">stdin</h4>
<p>Type: <code>string</code> <code>number</code> <code>Stream</code> <code>undefined</code> <code>null</code><br> Default: <code>pipe</code></p>
...
<a class="sourceLine" id="cb3-2" title="2"><span class="kw">const</span> getStream <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;get-stream&#39;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb3-3" title="3"></a>
<a class="sourceLine" id="cb3-4" title="4"><span class="kw">const</span> stream <span class="op">=</span> <span class="at">execa</span>(<span class="st">&#39;echo&#39;</span><span class="op">,</span> [<span class="st">&#39;foo&#39;</span>]).<span class="at">stdout</span><span class="op">;</span></a>
<a class="sourceLine" id="cb3-5" title="5"></a>
<a class="sourceLine" id="cb3-6" title="6"><span class="va">stream</span>.<span class="at">pipe</span>(<span class="va">process</span>.<span class="at">stdout</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb3-7" title="7"></a>
<a class="sourceLine" id="cb3-8" title="8"><span class="at">getStream</span>(stream).<span class="at">then</span>(value <span class="kw">=&gt;</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb3-9" title="9">    <span class="va">console</span>.<span class="at">log</span>(<span class="st">&#39;child output:&#39;</span><span class="op">,</span> value)<span class="op">;</span></a>
