...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">var</span> spawn <span class="op">=</span> <span class="at">require</span>(<span class="st">&#39;cross-spawn&#39;</span>)<span class="op">;</span></a>
...
<h4 id="options.shell-as-an-alternative-to-cross-spawn"><code>options.shell</code> as an alternative to <code>cross-spawn</code></h4>
