if (self.CavalryLogger) {
  CavalryLogger.start_js(["p6J0Y88"]);
}
  ...
  function (a, b, c, d, e, f) {
    ...
    g.Builder.prototype.addOffset = function (a) {
      this.prep(g.SIZEOF_INT, 0),
        this.writeInt32(this.offset() - a + g.SIZEOF_INT);
    };
    ...
    g.Builder.prototype.endObject = function () {
      ...
      this.addInt32(0);
      var a = this.offset();
      for (var b = this.vtable_in_use - 1; b >= 0; b--)
        this.addInt16(this.vtable[b] != 0 ? a - this.vtable[b] : 0);
      var c = 2;
      ...
      outer_loop: for (var b = 0; b < this.vtables.length; b++) {
        ...
        if (f == this.bb.readInt16(e)) {
          for (var h = g.SIZEOF_SHORT; h < f; h += g.SIZEOF_SHORT)
            if (this.bb.readInt16(d + h) != this.bb.readInt16(e + h))
              continue outer_loop;
          c = this.vtables[b];
          break;
        }
      ...
      c
        ? ((this.space = this.bb.capacity() - a),
          this.bb.writeInt32(this.space, c - a))
    ...
    g.Builder.prototype.finish = function (a, b) {
      if (b) {
        ...
        if (b.length != g.FILE_IDENTIFIER_LENGTH)
          throw new Error(
            "FlatBuffers: file identifier must be length " +
              g.FILE_IDENTIFIER_LENGTH
          );
        for (var c = g.FILE_IDENTIFIER_LENGTH - 1; c >= 0; c--)
          this.writeInt8(b.charCodeAt(c));
      }
    ...
    g.Builder.prototype.startVector = function (a, b, c) {
      this.notNested(),
        (this.vector_num_elems = b),
        this.prep(g.SIZEOF_INT, a * b),
        this.prep(c, a * b);
    };
    ...
    g.Builder.prototype.createString = function (a) {
      ...
      for (var c = 0, e = this.space, f = this.bb.bytes(); c < b.length; c++)
        f[e++] = b[c];
    ...
    g.ByteBuffer.prototype.writeInt32 = function (a, b) {
      (this.bytes_[a] = b),
        (this.bytes_[a + 1] = b >> 8),
        (this.bytes_[a + 2] = b >> 16),
        (this.bytes_[a + 3] = b >> 24);
    };
    ...
    g.ByteBuffer.prototype.writeFloat64 = function (a, b) {
      (g.float64[0] = b),
        this.writeInt32(a, g.int32[g.isLittleEndian ? 0 : 1]),
        this.writeInt32(a + 4, g.int32[g.isLittleEndian ? 1 : 0]);
    };
    ...
    g.ByteBuffer.prototype.__has_identifier = function (a) {
      if (a.length != g.FILE_IDENTIFIER_LENGTH)
        throw new Error(
          "FlatBuffers: file identifier must be length " +
            g.FILE_IDENTIFIER_LENGTH
        );
      for (var b = 0; b < g.FILE_IDENTIFIER_LENGTH; b++)
        if (a.charCodeAt(b) != this.readInt8(this.position_ + g.SIZEOF_INT + b))
          return !1;
      return !0;
    };
