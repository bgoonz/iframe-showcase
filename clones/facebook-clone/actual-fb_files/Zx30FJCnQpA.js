if (self.CavalryLogger) {
  CavalryLogger.start_js(["sJgB/37"]);
}
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = c("requireDeferred")("CreatorToolsGrowthEventFalcoEvent").__setRef(
      "CometCreatorToolsGrowthLoggingUtils"
    );
    function a(a, b) {
      h.onReady(function (c) {
        c.log(function () {
          return { event_type: b, surface: a };
        });
      });
    }
    g.logCreatorToolsGrowthEventComet = a;
  },
  98
);
__d(
